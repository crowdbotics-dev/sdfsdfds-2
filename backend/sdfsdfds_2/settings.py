"""
Django settings for sdfsdfds_2 project.
...
WSGI_APPLICATION = 'sdfsdfds_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sdfsdfds_2 API",
    "DESCRIPTION": "API documentation for sdfsdfds_2 App",
    "VERSION": "v1",
}
